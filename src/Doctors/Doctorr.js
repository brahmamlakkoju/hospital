...
function Doctorr() {
  ...
  const handleAddDoctor = (newDoctor) => {
    ...
    axios.post('https://managementbackend-ujed.onrender.com/doctors', newDoctor)
      .then((response) => {
  ...
  useEffect(() => {
    axios.get('https://managementbackend-ujed.onrender.com/doctors')
      .then((response) => {
  ...
  const handleDeleteDoctor = (doctorId) => {
    ...
    axios.delete(`https://managementbackend-ujed.onrender.com/doctors/${doctorId}`)
      .then(() => {
  ...
  const handleEditDoctor = (editedDoctor) => {
    ...
    axios.put(`https://managementbackend-ujed.onrender.com/doctors/${editedDoctor.id}`, editedDoctor)
      .then(() => {
