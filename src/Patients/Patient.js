...
function Patient() {
  ...
  const handleAddPatient = (newPatient) => {
    ...
    axios.post('https://managementbackend-ujed.onrender.com/patients', newPatient)
      .then((response) => {
  ...
  useEffect(() => {
    axios.get('https://managementbackend-ujed.onrender.com/patients')
  .then((response) => {
  ...
  const handleDeletePatient = (PatientId) => {
    ...
    axios.delete(`https://managementbackend-ujed.onrender.com/Patients/${PatientId}`)
      .then(() => {
  ...
  const handleEditPatient = (editedPatient) => {
    ...
    axios.put(`https://managementbackend-ujed.onrender.com/Patients/${editedPatient.id}`, editedPatient)
      .then(() => {
